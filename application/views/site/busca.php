<div class="inner-banner">
    <div class="container">
        <div class="inner-banner-dec">
            <h5>Resultados para Categoria:</h5>
            <div class="clear"></div>
            <span><?= ($categoria_pesquisada) ? urldecode($categoria_pesquisada) : 'Ops... Pesquisa Vazia.'?></span>
            <div class="clear"></div>
            <ol class="breadcrumb">
                <li><a href="<?= base_url()?>">Página Inicial</a></li>
                <li><a href="javascript:">Categoria</a></li>
                <li class="active"><?= ($categoria_pesquisada) ? urldecode($categoria_pesquisada) : 'Ops... Pesquisa Vazia.'?></li>
            </ol>
        </div>
        <div class="thumb">
                        ...
                        <div class="blog-grid3">
                            <div class="row">
                                ...
                                <?php }else{?>
                                    <div class="heading-3">
                                        <h2>Opss...  Desculpe</h2>
                                        <span>Ainda não temos livros disponíveis nesta categoria.</span>
                                    </div>
                                <?php }?>
                            </div>
                        </div>
